...
import { CRUD_APP_PROGRAM_ADDRESS } from "../programs";
import {
  expectAddress,
  expectSome,
...
export type UpdateJournalEntryInstruction<
  TProgram extends string = typeof CRUD_APP_PROGRAM_ADDRESS,
...
export async function getUpdateJournalEntryInstructionAsync<
  ...
  TAccountOwner extends string,
  TAccountSystemProgram extends string,
  TProgramAddress extends Address = typeof CRUD_APP_PROGRAM_ADDRESS,
>(
...
> {
  // Program address.
  const programAddress = config?.programAddress ?? CRUD_APP_PROGRAM_ADDRESS;
